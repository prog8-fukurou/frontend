	...
	return (
		<div className="container h-screen flex flex-col justify-center items-center gap-16 relative">
			...
			<div className="flex flex-col gap-16">
				<Button size={'lg'} className="text-base bg-sky-700" onClick={handleCreateRoom}>
					新しい部屋を作る
				</Button>
				<form onSubmit={handleEnterRoom} className="flex mx-auto gap-4 items-end">
					<div className="grid w-full max-w-sm items-center gap-1.5">
						<Label htmlFor="roomId">部屋コードを入力</Label>
						<Input type="text" id="roomId" name="roomId" defaultValue={''} placeholder="部屋コード" />
					</div>
			...
			<Button variant="link" className="text-lg absolute bottom-10 right-10 xl:bottom-20 xl:right-20 2xl:bottom-40">
