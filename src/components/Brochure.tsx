  ...
  return (
    <>
      <div className="w-full m-8">
        <div
          className="border-l-4 pl-4 text-lg font-semibold"
...
export function Brochure(props: {
  ...
  return (
    <>
      <div
        className="w-full h-full md:flex items-center justify-center md:border rounded-md"
        style={BorderColor}
      >
        <div className="h-full md:w-1/2 p-4">
          <div className="font-bold text-3xl text-center m-6">
            {props.base.travel_plan_name}
          </div>
          <div className="text-center m-2 text-slate-700">
            @ {props.base.travel_place}
          </div>
          <div className="text-start m-6">
            {props.base.travel_plan_description}
          </div>
        ...
        <div className="h-full md:w-1/2 md:h-full md:border-l-8 p-4">
          <div>
          ...
          <div>
            <div>
              <div
                className="border-l-4 pl-4 text-lg font-semibold m-8"
                style={BorderColor}
              >
                おすすめ観光スポット
              </div>
